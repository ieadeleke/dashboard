...
export type FilterOperatorOption = "name" | "date"

type FilterFleetPayloadParams = {
    selectedOption?: FilterOperatorOption,
    onOptionSelected?: (option: FilterOperatorOption) => void
}

type FilterOperatorModalProps = {
   
}

export type FilterOperatorModalRef = {
    open: (payload: FilterFleetPayloadParams) => void,
    close: () => void
}


export const FilterOperatorModal = forwardRef<FilterOperatorModalRef, FilterOperatorModalProps>((props, ref) => {
    const [isOptionOpen, setIsOptionOpen] = useState(false)
    const [filterOption, setFilterOption] = useState<FilterOperatorOption>("name")
    const onOptionSelected = useRef<(value: FilterOperatorOption) => void>()
...
FilterOperatorModal.displayName = "FilterOperatorModal"