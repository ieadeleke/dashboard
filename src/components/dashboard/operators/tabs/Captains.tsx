...
import { FilterOperatorModal, FilterOperatorModalRef, FilterOperatorOption } from "../FilterOperatorModal"
...
export const Captains = (props: CaptainsProps) => {
    ...
    useEffect(() => {
        fetchOperators({ page, profileType: "captain" })
    }, [page])
