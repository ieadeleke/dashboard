...
export type AddIncidentWithPeopleModalRef = {
  open: () => void;
  close: () => void;
};
...
export const AddIncidentWithPeopleModal = forwardRef<
  AddIncidentWithPeopleModalRef,
  AddIncidentWithPeopleModalProps
>((props, ref) => {
...
AddIncidentWithPeopleModal.displayName = "AddIncidentWithPeopleModal";
