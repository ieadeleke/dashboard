...
import {
  FilterIncidentModal,
  FilterIncidentModalRef,
  FilterIncidentOption,
} from "../FilterIndidentModal";
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col items-start p-4 bg-white gap-4 md:flex-row md:items-center">
          ...
          <div
            ...
            className="flex items-center gap-3 cursor-pointer text-text-normal font-semibold border rounded-md px-2 py-3"
          >
            <p>Filter</p>
          ...
          <Popover>
            ...
            <PopoverContent className="flex flex-col w-auto px-2 py-1 gap-3">
              <div
                onClick={props.addNewVesselIncident}
                className="flex items-center px-2 gap-2 cursor-pointer py-2 hover:bg-gray-100 rounded-md"
              >
              ...
              <div
                onClick={props.addNewIndividualIncident}
                className="flex items-center px-2 gap-2 cursor-pointer py-2 hover:bg-gray-100 rounded-md"
              >
              ...
              <div
                onClick={props.addNewObjectIncident}
                className="flex items-center px-2 gap-2 cursor-pointer py-2 hover:bg-gray-100 rounded-md"
              >
                <PersonStandingIcon className="text-primary" />
