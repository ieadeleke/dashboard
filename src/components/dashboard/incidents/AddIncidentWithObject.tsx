...
const schema = z
  .object({
    ...
    accident_location: z
      ...
      .max(500),
    object_type: z
      .string({ required_error: "Insert a valid object type" })
      .min(3, "Location must be at least 3 characters"),
    possible_cause: z
      .string({ required_error: "Insert a valid possible cause" })
      .min(3, "Possible cause must be at least 3 characters"),
    accident_cause: z
      .string({ required_error: "Insert a valid accident cause" })
      .min(3, "Accident cause must be at least 3 characters"),
    no_of_casualties: z
      .number({ required_error: "Number of casualties must be at least 0" })
      .min(0, "Number of casualties must be at least 0"),
  })
  .required();
...
export const AddIncidentWithObjectModal = forwardRef<
  AddIncidentWithObjectModalRef,
  AddIncidentWithObjectModalProps
>((props, ref) => {
      ...
      <DialogContent className="max-h-[90vh] overflow-y-scroll no-scrollbar">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <AdminInputField
              inputMode="numeric"
              value={state.no_of_casualties}
              onChange={onNumberOfCasualties}
            />
          </div>
          ...
          <div className="p-2 flex flex-col gap-2 bg-gray-100">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2">
                ...
                <CheckBox
                  isChecked={!state.rescued}
                  onValueChange={() => toggleRescued(false)}
                  checkIconClassName="w-2 h-2"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <CheckBox
                  isChecked={state.rescued}
                  onValueChange={() => toggleRescued(true)}
                  checkIconClassName="w-2 h-2"
                />
              </div>
            </div>
          ...
          <div className="border rounded-lg p-2 flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2">
                ...
                <CheckBox
                  onValueChange={(value) => toggleMaleGender()}
                  isChecked={state.gender}
                  checkIconClassName="w-2 h-2"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <CheckBox
                  onValueChange={(value) => toggleFemaleGender()}
                  isChecked={!state.gender}
                  checkIconClassName="w-2 h-2"
                />
              </div>
              ...
              <div className="border rounded-lg p-2 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-2">
                    <p className="text-sm">No</p>
                    <CheckBox
                      isChecked={!state.missing}
                      onValueChange={() => toggleMissing(false)}
                      checkIconClassName="w-2 h-2"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <CheckBox
                      isChecked={state.missing}
                      onValueChange={() => toggleMissing(true)}
                      checkIconClassName="w-2 h-2"
                    />
                  </div>
                </div>
              ...
              <div className="border rounded-lg p-2 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-2">
                    <p className="text-sm">No</p>
                    <CheckBox
                      isChecked={!state.injury}
                      onValueChange={() => toggleInjury(false)}
                      checkIconClassName="w-2 h-2"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <CheckBox
                      isChecked={state.injury}
                      onValueChange={() => toggleInjury(true)}
                      checkIconClassName="w-2 h-2"
                    />
                  </div>
                </div>
              ...
              <div className="border rounded-lg p-2 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-2">
                    <p className="text-sm">No</p>
                    <CheckBox
                      isChecked={!state.death}
                      onValueChange={() => toggleDeath(false)}
                      checkIconClassName="w-2 h-2"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <CheckBox
                      isChecked={state.death}
                      onValueChange={() => toggleDeath(true)}
                      checkIconClassName="w-2 h-2"
                    />
                  </div>
                </div>
