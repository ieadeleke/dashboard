...
const Button = forwardRef<HTMLButtonElement, ForwardRefButtonProps>((props, ref) => {
    ...
    return <button className={cn(`rounded-[8px] h-[50px] text-base text-base-semibold ${bgClassName} ${disabled ? 'opacity-50' : ''}`, className)} ref={ref} onClick={handleOnClick} {...rest}>
